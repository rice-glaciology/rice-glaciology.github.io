      ...
      text: |
        **Open posting &mdash; Poromechanical modeling of Gulf Coast sea-level change**
        ...
        <div class="opp-body">
          ...
          <ul>
            <li>PhD in geophysics, Earth sciences, hydrology, or a closely related field</li>
            <li>Strong quantitative and computational skills</li>
          </ul>

          <p><strong>Ideal qualifications</strong></p>
          <ul>
            <li>Background in geodesy, geomechanics, or groundwater processes</li>
            <li>Experience with numerical modeling and large geophysical or climate datasets</li>
            <li>Experience with Python, scientific code development, and high-performance computing</li>
            <li>Strong written and oral communication skills</li>
          </ul>

          <p><strong>The initial appointment is for 2 years, with the possibility of extension subject to funding availability. Start date is flexible.</strong></p>
